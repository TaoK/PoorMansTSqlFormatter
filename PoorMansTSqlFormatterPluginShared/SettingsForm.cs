...
namespace PoorMansTSqlFormatterPluginShared
{
    public partial class SettingsForm : Form
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                var _generalResourceManager = new System.Resources.ResourceManager("PoorMansTSqlFormatterPluginShared.GeneralLanguageContent", Assembly.GetExecutingAssembly());
        ...
        private void btn_Reset_Click(object sender, EventArgs e)
        {
            ...
            if (_supportsHotkey && _hotkeyDefaultFixMethod != null)

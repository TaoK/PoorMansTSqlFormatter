...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    ...
    public class ScintillaGateway : IScintillaGateway
    {
        ...
        /// <summary>
        /// Retrieve the text in the document up to the specified number of "text characters" (utf-8 bytes?)
        /// (Scintilla feature 2182, manually re-exposed because autogenerated version is wrong)
        /// </summary>
        public unsafe string GetText_Fixed(int length)
        {
        ...
        /// (Scintilla feature 2161, manually re-exposed because autogenerated version is wrong)
        /// </summary>
        public unsafe string GetSelText_Fixed()
        {
            byte[] textBuffer = new byte[GetSelectionLength()];
            fixed (byte* textPtr = textBuffer)
            {
